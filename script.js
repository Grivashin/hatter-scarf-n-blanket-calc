...
function calculate() {
  ...
  const translations = {
    ru: {
      ...
      unitMetric: 'см',
      unitImperial: 'дюймы',
      warningKnit: 'Перед измерением плотности проведите влажно-тепловую обработку образца: постирайте, высушите на горизонтальной поверхности, при необходимости отпарьте. Образец должен быть не менее 12×12 см (5×5 дюймов) после ВТО. Плотность измеряйте строго в центре образца, на участке 10×10 см (4×4 дюйма), не включая кромочные и края. Если изделие будете вязать по кругу, образец обязательно свяжите по кругу, так как плотность кругового и поворотного вязания различается.,
      warningCrochet: 'Перед измерением плотности проведите влажно-тепловую обработку образца: постирайте, высушите на горизонтальной поверхности, при необходимости отпарьте. Образец должен быть не менее 12×12 см (5×5 дюймов) после ВТО. Плотность измеряйте строго в центре образца, на участке 10×10 см (4×4 дюйма), не включая крайние столбики и петли подъёма. Если изделие будете вязать по кругу, образец обязательно свяжите по кругу — плотность кругового и поворотного вязания крючком может различаться.',
      toolKnit: 'Спицы',
      toolCrochet: 'Крючок',
    ...
    us: {
      ...
      unitMetric: 'cm',
      unitImperial: 'in',
      warningKnit: 'Before measuring gauge, wash and block your swatch: wash it, dry it flat, and steam if needed. The swatch must be at least 5×5 inches (12×12 cm) after blocking. Measure gauge strictly in the center of the swatch, on a 4×4 inches (10×10 cm) area, excluding edge stitches and borders. If you plan to knit your project in the round, knit the swatch in the round as well — gauge can differ between flat and circular knitting.',
      warningCrochet: 'Before measuring gauge, wash and block your swatch: wash it, dry it flat, and steam if needed. The swatch must be at least 5×5 inches (12×12 cm) after blocking. Measure gauge strictly in the center of the swatch, on a 4×4 inches (10×10 cm) area, excluding edge stitches and turning chains. If you plan to crochet your project in the round, crochet the swatch in the round as well — gauge can differ between flat and circular crochet.',
      toolKnit: 'Knitting',
      toolCrochet: 'Crochet',
      lblRepSt: 'Repeat (sts)',
      ...
      edgeDesc: '0 — circular, 2 — flat rows',
    ...
    uk: {
      ...
      unitMetric: 'cm',
      unitImperial: 'in',
      warningKnit: 'Before measuring tension, wash and block your tension swatch: wash it, dry it flat, and steam if needed. The tension swatch must be at least 5×5 inches (12×12 cm) after blocking. Measure tension strictly in the centre of the swatch, on a 4×4 inches (10×10 cm) area, excluding edge stitches and borders. If you plan to knit your project in the round, knit the tension swatch in the round as well — tension can differ between flat and circular knitting.',
      warningCrochet: 'Before measuring tension, wash and block your tension swatch: wash it, dry it flat, and steam if needed. The tension swatch must be at least 5×5 inches (12×12 cm) after blocking. Measure tension strictly in the centre of the swatch, on a 4×4 inches (10×10 cm) area, excluding edge stitches and turning chains. If you plan to crochet your project in the round, crochet the tension swatch in the round as well — tension can differ between flat and circular crochet.',
      toolKnit: 'Knitting',
      toolCrochet: 'Crochet',
      lblRepSt: 'Repeat (sts)',
      lblRepRow: 'Repeat (rows)',
